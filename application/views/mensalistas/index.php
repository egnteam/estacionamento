...
/** @var Mensalistas $titulo_tabela */
/** @var Mensalistas $mensalistas */
						...
						<div class="card-body">
							<table class="table data-table">
								...
								<?php foreach ($mensalistas as $mensalista) : ?>
										...
										<td class="text-right">
											<a data-toggle="tooltip" data-placement="bottom"
											   ...
											   class="btn btn btn-icon btn-primary"> <i class="ik ik-edit-2"></i>
												<a/>
												<?php //user-<?php echo $mensalistas->id; ?>
									...
									<div class="modal fade" id="mensalista-<?php echo $mensalista->mensalista_id ?>"
										 tabindex="-1"
										 role="dialog"
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a data-toggle="tooltip" data-placement="bottom"
													   ...
													   href="<?php echo base_url($this->router->fetch_class() . '/del/' . $mensalista->mensalista_id); ?> "
