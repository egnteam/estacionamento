...
/** @var Formas $titulo */
/** @var Formas $forma */
/** @var Formas $icone_view */
/** @var Formas $sub_titulo */
/** @var Formas $icone_view */
/**
 * */
?>
	...
	<div class="main-content">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="card-header"><?php echo(isset($forma) ? '
								<i class="ik ik-calendar ik-2x:">
								</i>&nbsp;data da última alteração: &nbsp;' . formata_data_banco_com_hora($forma->forma_pagamento_data_alteracao) : ""); ?>
						</div>
						<div class="card-body">
