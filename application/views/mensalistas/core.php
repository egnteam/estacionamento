...
/** @var Mensalistas $titulo */
/** @var Mensalistas $mensalista */
/** @var Mensalistas $icone_view */
/** @var Mensalistas $sub_titulo */
/** @var Mensalistas $sub_titulo */
	...
	<div class="main-content">
		<div class="container-fluid">
						...
						<nav class="breadcrumb-container" aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li data-toggle="tooltip" data-placement="bottom" class="breadcrumb-item active"
									aria-current="page"><?php echo $titulo ?></li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="card-header"><?php echo(isset($mensalista) ? '<i class="ik ik-calendar ik-2x:"></i>&nbsp;data da última alteração: &nbsp;' . formata_data_banco_com_hora($mensalista->mensalista_data_cadastro) : ""); ?></div>
						<div class="card-body">
							...
							<form class="forms-sample" name="form_core" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-2 mb-20">
										...
										<input type="date" class="form-control"
											   name="mensalista_data_cadastro"
											   value="<?php echo(isset($mensalista) ? $mensalista->mensalista_data_cadastro : set_value('mensalista_data_cadastro')); ?>">
										<?php echo form_error('mensalista_data_cadastro', '<div class="text-danger">', '</div>'); ?>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-2 mb-20">
										...
										<input type="text" class="form-control sp_celphones"
											   name="mensalista_telefone_movel"
									...
									<div class="col-md-2 mb-20">
										<label>Numero</label>
										<input type="text" class="form-control"
											   name="mensalista_numero_endereco"
								...
								<div class="form-group row">
									...
									<div class="col-md-6 mb-20">
										...
										<input type="text" class="form-control"
											   name="mensalista_dia_vencimento"
									...
									<div class="col-md-4 mb-20">
										<label>Obeservaççao sobre mensalidade</label>
										<textarea rows="1" class="form-control" name="mensalista_observacao"
												  value="<?php echo(isset($mensalista) ? $mensalista->mensalista_observacao : set_value('mensalista_observacao')); ?>">
										<?php echo form_error('mensalista_observacao', '<div class="text-danger">', '</div>'); ?> </textarea>
									</div>
