...
<head>
	...
	<title> Par Now &nbsp; |
		&nbsp; <?php echo(isset($titulo) ? $titulo : 'Um novo conceito em estacionamento!'); ?> </title>
	...
	<?php //echo base_url('public/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css') ?><!--">-->
	<!--	<link rel="stylesheet" href="-->
	<?php //echo base_url('public/plugins/jvectormap/jquery-jvectormap.css') ?><!--">-->
	<!--	<link rel="stylesheet" href="-->
	<?php //echo base_url('public/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css') ?><!--">-->
	<!--	<link rel="stylesheet" href="-->
	<?php //echo base_url('public/plugins/weather-icons/css/weather-icons.min.css') ?><!--">-->
	<!--	<link rel="stylesheet" href="--><?php //echo base_url('public/plugins/c3/c3.min.css') ?><!--">-->
	<!--	<link rel="stylesheet" href="-->
	<?php //echo base_url('public/plugins/owl.carousel/dist/assets/owl.carousel.min.css') ?><!--">-->
	<!--	<link rel="stylesheet" href="-->
	<?php //echo base_url('public/plugins/owl.carousel/dist/assets/owl.theme.default.min.css') ?><!--">-->
