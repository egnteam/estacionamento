...
//		exit();
	...
	public function core($precificacao_id = NULL): void
	{
		...
		if (!$precificacao_id) {
			...
			$this->form_validation->set_rules('precificacao_categoria', 'Categoria', 'trim|required|is_unique[precificacoes.precificacao_categoria]');
			...
			if ($this->form_validation->run()) {
				...
				$data = array(
					...
					'sub_titulo' => 'Chegou a Hora de Cadastrar a preficação',
					'icone_view' => 'fa-solid fa-dollar-sign',
