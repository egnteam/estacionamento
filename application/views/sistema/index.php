...
/** @var Sistema $titulo */
/** @var Sistema $sistema */
/** @var Sistema $icone_view */
/** @var Sistema $sub_titulo */
/** @var Sistema $perfil_usuario */
?>
							...
							<form class="forms-sample" name="form_index" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-2 mb-20">
										...
										<input type="text" class="form-control cep"
											   name="sistema_cep"
											   value="<?php echo(isset($sistema) ? $sistema->sistema_cep : set_value('sistema_cnpj')); ?>">
										<?php echo form_error('sistema_cep', '<div class="text-danger">', '</div>'); ?>
									</div>
									<div class="col-md-4 mb-20">
										<label>Endereço</label>
										<input type="text" class="form-control"
											   name="sistema_endereco"
								...
								<div class="form-group row">
									...
									<div class="col-md-12 mb-20">
										<label>Texto do ticket do estacionamento</label>
										<textarea class="form-control"
												  name="sistema_texto_ticket"
