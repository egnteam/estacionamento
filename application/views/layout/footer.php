...
<!--<script src="--><?php //echo base_url('public/js/tables.js')  ?><!--js/tables.js"></script>-->
<!---->
...
<?php if (isset($scripts)) : ?>
	<?php foreach ($scripts as $scripit): ?>
		<script src="<?php echo base_url('public/' . $scripit); ?>"></script>
	<?php endforeach; ?>
